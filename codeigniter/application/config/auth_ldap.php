 ...
 * use_ad           - Boolean to tell Auth_Ldap whether you are using AD or not.t
...
$config['hosts'] = array('ldaps://beaufort.winthrop.edu');
$config['ports'] = array(636);
$config['basedn'] = 'cn=Users,dc=acc,dc=winthrop,dc=edu';
$config['login_attribute'] = 'sAMAccountName';
$config['use_ad'] = true;
$config['ad_domain'] = 'ACC';
$config['proxy_user'] = 'cn=visitor,cn=Users,dc=acc,dc=winthrop,dc=edu';
$config['proxy_pass'] = 'winthrop';
